...
# %% paths
data_path = '/Users/calebjerinic-brodeur/Dropbox (ASU)/My Mac (Calebs-MacBook-Pro.local)/Desktop/SDS384_FinalProjectData_Team2/raw bold/'
sub_design_path = '/Users/calebjerinic-brodeur/Dropbox (ASU)/My Mac (Calebs-MacBook-Pro.local)/Desktop/SDS384_FinalProjectData_Team2/subejct_designs/'
combinedMask_path = '/Users/calebjerinic-brodeur/Dropbox (ASU)/My Mac (Calebs-MacBook-Pro.local)/Desktop/SDS384_FinalProjectData_Team2/combined_masks/'
results_path = '/Users/calebjerinic-brodeur/Dropbox (ASU)/My Mac (Calebs-MacBook-Pro.local)/Desktop/ML_final/Results/'
...
def load_data(directory, subject_name, mask_name="", num_runs=3, zscore_data=False):
    existing_bold_data = f'/Users/calebjerinic-brodeur/Dropbox (ASU)/My Mac (Calebs-MacBook-Pro.local)/Desktop/SDS384_FinalProjectData_Team2/concatenated/operation decoding/bold/sub{subject_name}_study_MNI_masked_bold.npy'
    if os.path.exists(existing_bold_data):
      ...
      np.save(
          f"/Users/calebjerinic-brodeur/Dropbox (ASU)/My Mac (Calebs-MacBook-Pro.local)/Desktop/SDS384_FinalProjectData_Team2/concatenated/operation decoding/bold/sub{subject_name}_study_MNI_masked_bold.npy",
          concatenated_data,
      )
